              ...
              <section className="grid gap-3 sm:grid-cols-2">
                {quickActions.map((action) => (
                  <SupportCard
                    ...
                    onClick={() =>
                      action.available && handleAction(action.action)
                    }
                  />
                ))}
              </section>
                ...
                <GlassCard className="p-5 text-center">
                  ...
                  >
                    <Button
                      variant="primary"
                      size="lg"
                      className="w-full rounded-xl bg-[#18b96f] text-white hover:bg-[#10945a]"
                    >
                      <Phone size={18} />
                      WhatsApp
                    </Button>
...
function SupportCard({
  ...
  return (
    ...
    >
      ...
      <span className="mt-1 block text-xs font-semibold text-[#68797d]">
        {description}
      </span>
    </button>
  );
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-3 sm:grid-cols-3">
        {Array.from({ length: 3 }).map((_, index) => (
          <div
            key={index}
            className="rounded-2xl border border-[rgba(232,50,123,0.18)] bg-white/80 p-4"
          >
