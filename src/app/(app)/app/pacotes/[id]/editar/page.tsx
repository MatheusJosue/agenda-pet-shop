      ...
      <header className="border-b border-white/10 backdrop-blur-md bg-white/5 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
          ...
          >
            ...
            <span className="font-medium">Voltar para Tipos de Pacote</span>
          </Link>
        </div>
      </header>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white mb-1" style={{ fontFamily: 'var(--font-outfit), sans-serif' }}>
                Editar Tipo de Pacote
              </h1>
              <p className="text-purple-200/60">Altere as informações do tipo de pacote</p>
            </div>
          </div>
        </div>
